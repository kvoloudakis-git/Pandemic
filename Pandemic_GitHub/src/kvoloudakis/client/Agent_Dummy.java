...
import kvoloudakis.server.Board;
import kvoloudakis.server.City;

public class Agent_Dummy  
{
    final static int ServerPort = 64240;
    final static String username = "Dummy";
    ...
    { 
        ...
        myUsername = username + "_" + myPlayerID;
                    ...
                    try { 
                        ...
                        if (timeToTalk)
                        {
                        	...
                        	while (myActionCounter < 4)
                        	{
                        		...
                        		destinationRandom = myCurrentCityObj.getNeighbour(randomNumber);
                        		
                        		System.out.println("Moving randomly to " + destinationRandom);
                        		
                        		myAction = myAction + toTextDriveTo(myPlayerID, destinationRandom);
                        		myActionCounter++;
                        		
                        		myBoard.driveTo(myPlayerID, destinationRandom);
                        	...
                        	String msgToSend;
                        	mySuggestion = "#C,"+myPlayerID+",This was my recommendation";
                        	
                        	if (myBoard.getWhoIsPlaying() == myPlayerID)
                        		msgToSend = myAction;
                        	else 
                        		msgToSend = mySuggestion;
